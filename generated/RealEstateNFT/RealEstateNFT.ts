...
export class RealEstateNFT__getPropertyResultValue0Struct extends ethereum.Tuple {
  get location(): string {
...
export class RealEstateNFT__propertiesResult {
  value0: string;
  value1: BigInt;
  value2: string;
  value3: string;
...
export class RealEstateNFT extends ethereum.SmartContract {
  ...
  getProperty(tokenId: BigInt): RealEstateNFT__getPropertyResultValue0Struct {
    let result = super.call(
      "getProperty",
    ...
    return changetype<RealEstateNFT__getPropertyResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getProperty(
    tokenId: BigInt,
  ): ethereum.CallResult<RealEstateNFT__getPropertyResultValue0Struct> {
    let result = super.tryCall(
      "getProperty",
      "getProperty(uint256):((string,uint256,string,string,bool,bool,address,address))",
      [ethereum.Value.fromUnsignedBigInt(tokenId)],
    ...
    return ethereum.CallResult.fromValue(
      changetype<RealEstateNFT__getPropertyResultValue0Struct>(
        value[0].toTuple(),
      ),
    );
  }
  ...
  properties(param0: BigInt): RealEstateNFT__propertiesResult {
    let result = super.call(
      "properties",
    ...
    return new RealEstateNFT__propertiesResult(
      result[0].toString(),
      result[1].toBigInt(),
      result[2].toString(),
      result[3].toString(),
  ...
  try_properties(
    param0: BigInt,
  ): ethereum.CallResult<RealEstateNFT__propertiesResult> {
    let result = super.tryCall(
      "properties",
      "properties(uint256):(string,uint256,string,string,bool,bool,address,address)",
      [ethereum.Value.fromUnsignedBigInt(param0)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new RealEstateNFT__propertiesResult(
        value[0].toString(),
        value[1].toBigInt(),
        value[2].toString(),
        value[3].toString(),
